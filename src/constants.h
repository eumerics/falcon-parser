...
uint8_t const pnt_chain_expression = expression_base + 9;
uint8_t const png_chain_expression = LHS;
uint8_t const pnt_array_assignment_pattern = expression_base + 10;
uint8_t const png_array_assignment_pattern = NONE;
uint8_t const pnt_object_assignment_pattern = expression_base + 11;
uint8_t const png_object_assignment_pattern = NONE;
uint8_t const pnt_lhs_expression = expression_base + 12;
uint8_t const png_lhs_expression = LHS; // for inheritence checks only
uint8_t const pnt_update_expression = expression_base + 13;
uint8_t const png_update_expression = NONE;
uint8_t const pnt_unary_expression = expression_base + 14;
uint8_t const png_unary_expression = NONE;
uint8_t const pnt_binary_expression = expression_base + 15;
uint8_t const png_binary_expression = NONE;
uint8_t const pnt_logical_expression = expression_base + 16;
uint8_t const png_logical_expression = NONE;
uint8_t const pnt_conditional_expression = expression_base + 17;
uint8_t const png_conditional_expression = NONE;
uint8_t const pnt_arrow_function_expression = expression_base + 18;
