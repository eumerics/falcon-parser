...
uint8_t const pnt_numeric_literal = 4;
uint8_t const png_numeric_literal = LHS | LITERAL;
uint8_t const pnt_string_literal = 5;
...
//
uint32_t const param_flag_loose_binding = 0x0001; // must be < 256
uint32_t const param_flag_unique_params = 0x0002;  // must be < 256
uint32_t const param_flag_strict_mode = 0x0004;
uint32_t const param_flag_loose_mode = 0x0008;
uint32_t const param_flag_module = 0x0010;
uint32_t const param_flag_annex = 0x0020;
//uint32_t const cover_flag_initializer = 0x0001; // both a param and state flag
uint32_t const cover_flag_parameters = 0x0040; // both a param and state flag
uint32_t const param_flag_for_binding = 0x0080;
uint32_t const param_flag_vanilla_function = 0x0100;
uint32_t const param_flag_function = 0x0200;
uint32_t const param_flag_method = 0x0400;
uint32_t const param_flag_constructor = 0x0800;
uint32_t const param_flag_class = 0x1000;
...
uint8_t const binding_flag_closure = 0x04;
